                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 pe-lg-4">
                            <div class="section-header">
                                ...
                                <h4 class="text-white text-uppercase border-line mt-3">MUHAMMAD AHMAD RIAZ</h4>
                            </div>
                        </div>
                        <div class="col-8">&nbsp;</div>
            ...
            <div class="container">
                ...
                <div class="team_inner">
                    <!-- Swiper Team -->
                        ...
                        <div class="row">
                          <div class="accordion mb-3" id="accordionAbout-1">
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                ...
                                <div class="people"><span>Ahmed Riaz</span>
                                <span>Principal Architect & CEO</span>
                                </div>
                            </button>
                              </h2>
                              <!-- Remove the "disabled-" prefix from the "data-bs-parent" attribute to enable collapsing of the item when another item is opened. -->
                              <div id="collapseOne-1" class="accordion-collapse collapse show" disabled-data-bs-parent="#accordionAbout-1">
                                <div class="accordion-body row">
                                    ...
                                    <div class="txtblock mt-5 col-md-8">
                            ...
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo-1" aria-expanded="false" aria-controls="collapseTwo-1">
                                    <div class="people"><span>Mr. Arsalan Khan</span>
                                        <span>Sales</span>
                                        </div>
                                </button>
                              </h2>
                            ...
                            <div class="accordion-item">
                              <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree-1" aria-expanded="false" aria-controls="collapseThree-1">
                                    <div class="people"><span>Mr. Tariq Khan</span>
                                        <span>Sales</span>
                                        </div>
                                </button>
                              </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour-1" aria-expanded="false" aria-controls="collapseFour-1">
                                      <div class="people"><span>Mr. Sumbal Arif</span>
                                          <span>Sales</span>
                                          </div>
                                  </button>
                                </h2>
